...
if (!kullanıcı) return message.channel.send('<a:Cros:788055287768678421>**Bir Hata Oluştu**<a:Cros:788055287768678421>\n\`Yanına Çağırmak İstediğin Kullanıcıyı Etikle.\`');

let member = message.guild.member(kullanıcı);

if (!member.voice.channel) return message.channel.send('<a:Cros:788055287768678421>**Bir Hata Oluştu**<a:Cros:788055287768678421>\n\`Yanına Çağırmak İstediğin Kişi Ses Kanalında Değil.\`').then(m => m.delete,{timeout: 5000});
