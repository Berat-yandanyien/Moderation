...
let rol = member.guild.roles.cache.find(r => r.name === "764893527683104849");
...
client.on('guildMemberAdd', async(member) => {
let mute = member.guild.roles.cache.find(r => r.name === "764893543118405665");
...
member.addRole("764893526869540864")
member.removeRole("764893484213075970")
member.send("**Sununucumuzda Yasaklı Tag Bulundurduğun İçin Cezalıya Atıldın.TAG'ınızı \`(₮)\` Salıp Yetkilileri Etiketleyiniz.")
}
})
